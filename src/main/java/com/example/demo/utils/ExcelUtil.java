     ...
     */
        ...
        public static <T> void exportExcel(List<T> datas, String fileName, String sheetName, HttpServletResponse response, boolean displayAll) throws IOException, IllegalAccessException {
            ...
            for (int i = 0; i < datas.size(); i++) {
                ...
                List<T> fieldsList = new ArrayList();
                while (clazz != null){
                    ...
                    for (int i = 1; i < rows; i++) {// 从第2行开始取数据,默认第一行是表头.
                        ...
                        for (int j = 0; j < cellNum; j++) {
                            ...
                            if ("true".equals(cell.getStringCellValue())){
                                c = "true";
                            }if ("false".equals(cell.getStringCellValue())){
                                c = "false";
                            }
                            if (c == null || c.equals("")) {
                                continue;
                            ...
                            if (String.class == fieldType) {
                                ...
                                field.set(entity, Long.valueOf(Integer.parseInt(c)));
...
//                                System.out.println(c+"--------"+cell.getStringCellValue()+"======"+Boolean.valueOf(c));
